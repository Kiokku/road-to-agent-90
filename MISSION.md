...
- 能独立解释主作品的事件流、工具权限、失败恢复和技术取舍。
- 通过围绕主作品的模拟面试，并开始投递前端 Agent / AI 应用岗位。
...
## Out of scope
- 在短期阶段把 AI Knowledge Assistant 等能力切片扩展为同期必须完成的独立项目。
- 创建一批与主作品互不关联的教程 Demo。
- 完整复刻 Kimi 网页的全部功能，或在短期阶段重做 Étiquette 的风格提取系统。
